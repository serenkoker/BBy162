...
class Simon() :
    def __init__(self, master):
         ...
         self.master.title("Simon Says Oyunu")
         self.master.update()
         ...
         self.anaRenkler = ("red", "green", "blue", "yellow")
    ...
    def kontrol_choice(self):
        ...
        if color == self.sira[self.sira_yeri]:
            if self.sira_yeri < len(self.sira) - 1:
                ...
                self.master.title("Simon Says - Skor: {}".format(len(self.sira)))
                self.sira.append(choice(self.anaRenkler))
                self.sira_yeri = 0
                self.sirayi_goster()
        else :
            self.master.title("Simon Says- Maalesef kaybettiniz! | Skorun: {}".format(len(self.sira)))
            self.sira[:] = []
            self.sira.append(choice(self.anaRenkler))
            self.sira_yeri = 0
            self.sirayi_goster()
